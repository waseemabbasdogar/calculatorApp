...
Instead of attaching individual listeners to every button, event listener attached to parent element, so whenever button clicks, it gets value from e.target 
